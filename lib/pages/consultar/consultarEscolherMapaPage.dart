...
import 'package:vfapp/pages/consultar/consultarAlimentacaoPage.dart';
import 'package:vfapp/pages/consultar/consultarMapaAlimentadoPage.dart';
import 'package:vfapp/pages/errorPage.dart';

class ConsultarEscolherMapaPage extends StatefulWidget {
  @override
  ConsultarEscolherMapaState createState() {
    return ConsultarEscolherMapaState();
  }
}

class ConsultarEscolherMapaState extends State<ConsultarEscolherMapaPage>
              ...
              if (snapshot.hasData) {
                return ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return verificaPesquisa(_controller.text,
                                snapshot.data!.mapas[index].cdMapa) ||
                            _controller.text == ''
                        ? Column(
                            children: [
                              CustomListTileSemImagem(
                                cor: snapshot.data!.mapas[index]
                                        .isMapaCarregadoEmMaquina
                                    ? Colors.green
                                    : Colors.black,
                                titulo:
                                    'Mapa ${snapshot.data!.mapas[index].cdMapa}',
                                subTitulo:
                                    'para o posto ${snapshot.data!.cdPt}',
                                onCustomPressed: () {
                                  ...
                                  /*Navigator.of(context)
                                      .push(MaterialPageRoute(
                                          builder: (context) => AlimentacaoPage(
                                              ...
                                              cdmapa: snapshot
                                                  .data!.mapas[index].cdMapa)))
                                      .then((value) {});*/
                                  Navigator.of(context)
                                      .push(MaterialPageRoute(
                                          builder: (context) =>
                                              ConsultarMapaAlimentadoPage(
                                                mapa: snapshot
                                                    .data!.mapas[index].cdMapa,
                                                posto: snapshot.data!.cdPt,
                                              )))
                                      .then((value) {});
                                },
                              ),
