...
class MainActivity: FlutterActivity() {
    private val COMMAND_CHANNEL = "br.com.map.vfapp/command"
    private val SCAN_CHANNEL = "br.com.map.vfapp/scan"
    private val PROFILE_INTENT_ACTION = "br.com.map.vfapp.SCAN"
